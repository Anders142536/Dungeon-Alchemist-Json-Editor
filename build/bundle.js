    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			div = element("div");
    			add_location(h2, file$5, 6, 0, 46);
    			attr_dev(div, "class", "editor-grid");
    			add_location(div, file$5, 7, 0, 62);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			div = element("div");
    			add_location(h2, file$4, 5, 0, 45);
    			attr_dev(div, "class", "editor-grid");
    			add_location(div, file$4, 6, 0, 61);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			div = element("div");
    			add_location(h2, file$3, 6, 0, 46);
    			attr_dev(div, "class", "editor-grid");
    			add_location(div, file$3, 7, 0, 64);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$2, 4, 0, 44);
    			add_location(div0, file$2, 7, 1, 94);
    			attr_dev(input0, "type", "color");
    			add_location(input0, file$2, 8, 1, 102);
    			attr_dev(input1, "type", "range");
    			attr_dev(input1, "min", "0");
    			attr_dev(input1, "max", "1");
    			attr_dev(input1, "step", "0.01");
    			add_location(input1, file$2, 11, 1, 136);
    			attr_dev(input2, "type", "number");
    			attr_dev(input2, "min", "0");
    			attr_dev(input2, "max", "1");
    			attr_dev(input2, "step", "0.01");
    			add_location(input2, file$2, 12, 1, 186);
    			attr_dev(input3, "type", "range");
    			attr_dev(input3, "min", "0");
    			attr_dev(input3, "max", "1000");
    			attr_dev(input3, "step", "1");
    			add_location(input3, file$2, 15, 1, 245);
    			attr_dev(input4, "type", "number");
    			attr_dev(input4, "min", "0");
    			attr_dev(input4, "max", "1000");
    			attr_dev(input4, "step", "1");
    			add_location(input4, file$2, 16, 1, 295);
    			attr_dev(div1, "class", "editor-grid");
    			add_location(div1, file$2, 5, 0, 60);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 8, 1, 93);
    			option0.__value = "0: ";
    			option0.value = option0.__value;
    			add_location(option0, file$1, 10, 2, 112);
    			option1.__value = "1: ";
    			option1.value = option1.__value;
    			add_location(option1, file$1, 11, 2, 151);
    			option2.__value = "2: ";
    			option2.value = option2.__value;
    			add_location(option2, file$1, 12, 2, 190);
    			add_location(select, file$1, 9, 1, 101);
    			attr_dev(div1, "class", "editor-grid");
    			add_location(div1, file$1, 6, 0, 60);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
